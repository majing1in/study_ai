package com.study.ai.spring.tools;
...
public class StockTools {
    ...
    public record Stock(Date date, BigDecimal price) {}
    ...
    public StockPriceResponse search_prices(
            @ToolParam(description = "股票代码") String code) {
        ...
        if (code.equals("TESLA")) {
            ...
            response.setStockList(List.of(
                    new Stock(today, new BigDecimal("12.21")),
